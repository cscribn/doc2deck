...
currentSolution1 - How they solve the problem today, first bullet point.
currentSolution2 - How they solve the problem today, second bullet point.
scale - Scale of the problem. 1-2 sentences.
whyNow - Why solve this now? 1-2 sentences.
ifUnsolved - What happens if unsolved? 1-2 sentences.
architectureApproach - Solution architecture and approach. 2-3 sentences.
approachReasons - Why this solution was chosen. 2-3 sentences.
personaBetterment - How this improves the persona's life. 1-2 sentences.
appfireBetterment - Value to Appfire (time saved, customers, retention). 1-2 sentences.
